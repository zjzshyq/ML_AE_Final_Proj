...
\vspace{-23pt}
\begin{center}
\textit{*Corresponding: y.hu7@student.uw.edu.pl}
\end{center}
...
```{r ologit_ai_margin, echo=FALSE, warning=FALSE}
...
[^10]: Please refer to the Appendix for the relevant code pertaining to the margins.oglmx algorithm.

In this section, we present the code implementation and the results for the estimation and marginal effects analysis of the probit model probit_ai. This analysis allows us to examine the differential impact of various variables on the rankings of AI-generated images.

```{r ref.label='ologit_ai_margin', eval = FALSE}
```
